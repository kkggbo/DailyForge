...
@Schema(description = "Single exercise detail with progression")
public record StatsExerciseDetailResponse(
        ...
        @Schema(description = "Appearance count", example = "5") int appearanceCount,
        ...
        @Schema(description = "Progression points by date ascending") List<StatsProgressionPointResponse> progression) {
}
