...
@Schema(description = "Updated current user basic profile response")
public record ProfileBasicUpdateResponse(
        ...
        @Schema(description = "Activity level", example = "moderate") String activityLevel,
