...
@Schema(description = "AI template generation history page response")
public record TemplateGenerationHistoryPageResponse(
        ...
        @Schema(description = "History records") List<TemplateGenerationHistoryItemResponse> records) {
}
